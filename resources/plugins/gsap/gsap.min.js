    ...
    Ut =
      ...
      (qt.paused = function paused(t) {
        return arguments.length
          ? (this._ps !== t && ((this._ps = t) ? ((this._pTime = this._tTime || Math.max(-this._delay, this.rawTime())), (this._ts = this._act = 0)) : (Ft(), (this._ts = this._rts), this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, 1 === this.progress() && Math.abs(this._zTime) !== X && (this._tTime -= X)))), this)
          : this._ps;
      }),
        ...
        if ((this !== I && m < v && 0 <= t && (v = m), v !== this._tTime || r || y)) {
          ...
          this._onUpdate && !e && Ct(this, 'onUpdate', !0),
            ((v === m && this._tTime >= this.totalDuration()) || (!v && _)) &&
              ((f !== this._start && Math.abs(l) === Math.abs(this._ts)) || this._lock || ((!t && g) || !((v === m && 0 < this._ts) || (!v && this._ts < 0)) || za(this, 1), e || (t < 0 && !_) || (!v && !_ && m) || (Ct(this, v === m && 0 <= t ? 'onComplete' : 'onReverseComplete', !0), !this._prom || (v < m && 0 < this.timeScale()) || this._prom())));
        }
        return this;
      }),
  ...
  function ke(t, e) {
    ...
    return s.svg && t.getAttribute('transform')
      ? '1,0,0,1,0,0' === (u = [(n = t.transform.baseVal.consolidate().matrix).a, n.b, n.c, n.d, n.e, n.f]).join(',')
        ? wr
        : u
      : (u !== wr || t.offsetParent || t === Re || s.svg || ((n = o.display), (o.display = 'block'), ((r = t.parentNode) && t.offsetParent) || ((a = 1), (i = t.nextElementSibling), Re.appendChild(t)), (u = je(t)), n ? (o.display = n) : Xd(t, 'display'), a && (i ? r.insertBefore(t, i) : r ? r.appendChild(t) : Re.removeChild(t))), e && 6 < u.length ? [u[0], u[1], u[4], u[5], u[12], u[13]] : u);
  }
  ...
  var Ee,
    ...
    Or = function _parseTransform(t, e) {
      ...
      return (
        ...
        (r.svg = !(!t.getCTM || !Wd(t))),
        B.translate &&
          (('none' === B.translate && 'none' === B.scale && 'none' === B.rotate) || (F[cr] = ('none' !== B.translate ? 'translate3d(' + (B.translate + ' 0 0').split(' ').slice(0, 3).join(', ') + ') ' : '') + ('none' !== B.rotate ? 'rotate(' + B.rotate + ') ' : '') + ('none' !== B.scale ? 'scale(' + B.scale.split(' ').join(',') + ') ' : '') + ('none' !== B[cr] ? B[cr] : '')),
